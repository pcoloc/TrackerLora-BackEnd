...
public class WebSecurityConfig {
    ...
    http.csrf().disable().authorizeRequests().antMatchers("/auth/*", "/ttnMapperData/**", "/actuator/*", "/swagger-ui/**", "/v3/api-docs/**").permitAll().anyRequest().authenticated().and().exceptionHandling().authenticationEntryPoint((request, response, authException) -> {
