...
public class WebSecurityConfig {
    ...
    http.csrf().disable().authorizeRequests().antMatchers("/auth/*", "/ttnMapper/*").permitAll().anyRequest().authenticated().and().exceptionHandling().authenticationEntryPoint((request, response, authException) -> {
